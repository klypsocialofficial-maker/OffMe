                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="flex items-center space-x-1">
                            ...
                            {(user.isVerified || user.username === 'Rulio' || ['Fabricio', 'fabricio'].includes(user.username)) && <VerifiedBadge tier={user.username === 'Rulio' ? 'black' : ['Fabricio', 'fabricio'].includes(user.username) ? 'silver' : user.premiumTier} className="w-[14px] h-[14px]" />}
                          </div>
