...
import { X, Instagram, Download, Share2, SendHorizontal } from 'lucide-react';
            ...
            >
              ...
              <div className="p-6 grid grid-cols-1 gap-3">
                <button
                  ...
                  className="w-full bg-white text-black py-4 rounded-2xl font-bold flex items-center justify-center space-x-3 border border-gray-200 hover:bg-gray-50 transition-all active:scale-95"
                >
