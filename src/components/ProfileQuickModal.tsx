              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0">
                  <div className="flex items-center space-x-1">
                    ...
                    {(userProfile?.isVerified || userProfile?.username === 'Rulio' || ['Fabricio', 'fabricio'].includes(userProfile?.username)) && <VerifiedBadge className="w-3 h-3" tier={userProfile?.username === 'Rulio' ? 'black' : ['Fabricio', 'fabricio'].includes(userProfile?.username) ? 'silver' : userProfile?.premiumTier} />}
                  </div>
